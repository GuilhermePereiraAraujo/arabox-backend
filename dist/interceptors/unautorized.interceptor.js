...
const unautorized_error_1 = require("../error/unautorized.error");
let UnauthorizedInterceptor = class UnauthorizedInterceptor {
    intercept(context, next) {
        return next.handle().pipe((0, operators_1.catchError)((error) => {
            if (error instanceof unautorized_error_1.UnauthorizedError) {
...
//# sourceMappingURL=unautorized.interceptor.js.map